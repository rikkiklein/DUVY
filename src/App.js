      ...
      <div className="App">
      				...
      				<div className="inner">
      					<nav>
      						<ul>
      							...
      							<li><a href="#one">About David</a></li>
      							<li><a href="#two">What I Do</a></li>
      							<li><a href="#three">Contact Information</a></li>
      						</ul>
      					</nav>
      				</div>
      			</section>
      			...
      			<div id="wrapper">
      					...
      					<section id="intro" className="wrapper fullscreen fade-up">
      						<div className="inner">
      							<h1>David <span className="diff-color">Klein</span></h1>
                    <h2>Civil <span className="diff-color">Engineer</span></h2>
